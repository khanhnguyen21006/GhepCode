...
public class PtzFragment extends Fragment implements View.OnClickListener, SurfaceHolder.Callback, MediaPlayer.OnPreparedListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private Button ptzUp, ptzDown, ptzLeft, ptzRight, ptzHome,btnSetPreset,btnGoToPreset, btnSend;
    ...
    private String videoPath = "rtsp://192.168.0.122:554/onvif1";
...
//        });
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    response = httpclient.execute(new HttpGet("http://lab411s.esy.es/sg/rx.php?data=van"));
...
//        });
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if(statusLine.getStatusCode() == HttpStatus.SC_OK) {
                                ...
                                response.getEntity().writeTo(out);
                                String responseString = out.toString();
                                //String ip= responseString.substring(3,4);
                                // String mac= responseString.substring(8,2);
                                if(responseString.toString().equals("van")){
        ...
        ptzHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               // tv_thongbao.setText(spinner_cmd.getSelectedItem().toString());//
...
//            return;
        ...
        serviceUrl = "http://192.168.0.122:5000/onvif/device_service";
        getActivity().setVolumeControlStream(AudioManager.STREAM_MUSIC);
        Dbug.w(tag, "url=" + url);
